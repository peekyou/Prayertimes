...
namespace PrayerTimes.View
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : PrayerTimes.Common.LayoutAwarePage
    {
        ...
        private void resultsGridView_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                this.Frame.Navigate(typeof(CalendarPage), location);
            }
            catch
            {
            }
        ...
        /// </summary>
        private sealed class Filter : PrayerTimes.Common.BindableBase
        {
