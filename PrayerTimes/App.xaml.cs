...
namespace PrayerTimes
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            // Obligé de vérifier sinon black screen par manque d'opération await qui dure...
            ApplicationDataContainer localSettings = ApplicationData.Current.LocalSettings;
            if (string.IsNullOrEmpty((string)localSettings.Values["city"]))
            {
                SplashScreen splashScreen = args.SplashScreen;
                ExtendedSplashScreen eSplash = new ExtendedSplashScreen(splashScreen, false);
        ...
        /// <summary>
        /// Invoked to remove the splash screen from view
        /// </summary>
        void RemoveExtendedSplash()
        {
            // Create a Frame to act navigation context and navigate to the first page
            var rootFrame = new Frame();
            if (!rootFrame.Navigate(typeof(CalendarPage), prayerViewModel))
            {
        ...
        {
            PrayerTimes.View.SearchResultsPage.Activate(args.QueryText, args.PreviousExecutionState);
        }
    }
}
